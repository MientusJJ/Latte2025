...
std::string Ar::getType() {
    return type_->get();
}

std::string Ar::getIdent()  {
    return ident_;
}
...
/********************   SimpleVarType    ********************/
SimpleVarType::SimpleVarType(SimpleType *p1)
{
  simpletype_ = p1;

}

SimpleVarType::SimpleVarType(const SimpleVarType & other)
{
  simpletype_ = other.simpletype_->clone();

}

SimpleVarType &SimpleVarType::operator=(const SimpleVarType & other)
{
  SimpleVarType tmp(other);
  swap(tmp);
  return *this;
}

void SimpleVarType::swap(SimpleVarType & other)
{
...
void SimpleVarType::accept(Visitor *v)
{
  v->visitSimpleVarType(this);
}

SimpleVarType *SimpleVarType::clone() const
{
  return new SimpleVarType(*this);
}
std::string SimpleVarType::get()  {
    return simpletype_->get();
}


/********************   SimpleArrType    ********************/
SimpleArrType::SimpleArrType(SimpleType *p1)
{
  simpletype_ = p1;

}

SimpleArrType::SimpleArrType(const SimpleArrType & other)
{
  simpletype_ = other.simpletype_->clone();

}

SimpleArrType &SimpleArrType::operator=(const SimpleArrType & other)
{
  SimpleArrType tmp(other);
  swap(tmp);
  return *this;
}

void SimpleArrType::swap(SimpleArrType & other)
{
  std::swap(simpletype_, other.simpletype_);

}

SimpleArrType::~SimpleArrType()
{
  delete(simpletype_);

}

void SimpleArrType::accept(Visitor *v)
{
  v->visitSimpleArrType(this);
}

SimpleArrType *SimpleArrType::clone() const
{
  return new SimpleArrType(*this);
}

std::string SimpleArrType::get()  {
    return simpletype_->get() + "[]";
}
...
/********************   EVarSimpleNew    ********************/
EVarSimpleNew::EVarSimpleNew(SimpleType *p1)
{
  simpletype_ = p1;

}

EVarSimpleNew::EVarSimpleNew(const EVarSimpleNew & other)
{
  simpletype_ = other.simpletype_->clone();

}

EVarSimpleNew &EVarSimpleNew::operator=(const EVarSimpleNew & other)
{
  EVarSimpleNew tmp(other);
  swap(tmp);
  return *this;
}

void EVarSimpleNew::swap(EVarSimpleNew & other)
{
  std::swap(simpletype_, other.simpletype_);

}

EVarSimpleNew::~EVarSimpleNew()
{
  delete(simpletype_);

}

void EVarSimpleNew::accept(Visitor *v)
{
  v->visitEVarSimpleNew(this);
}

EVarSimpleNew *EVarSimpleNew::clone() const
{
  return new EVarSimpleNew(*this);
}
...
/********************   EArrSimpleNew    ********************/
EArrSimpleNew::EArrSimpleNew(SimpleType *p1, Expr *p2)
{
  simpletype_ = p1;
  expr_ = p2;
...
EArrSimpleNew::EArrSimpleNew(const EArrSimpleNew & other)
{
  simpletype_ = other.simpletype_->clone();
  expr_ = other.expr_->clone();
...
EArrSimpleNew &EArrSimpleNew::operator=(const EArrSimpleNew & other)
{
  EArrSimpleNew tmp(other);
  swap(tmp);
  return *this;
}

void EArrSimpleNew::swap(EArrSimpleNew & other)
{
  std::swap(simpletype_, other.simpletype_);
  std::swap(expr_, other.expr_);
...
void EArrSimpleNew::accept(Visitor *v)
{
  v->visitEArrSimpleNew(this);
}

EArrSimpleNew *EArrSimpleNew::clone() const
{
  return new EArrSimpleNew(*this);
}
...
/********************   EVarSimpleCast    ********************/
EVarSimpleCast::EVarSimpleCast(SimpleType *p1, Expr *p2)
{
  simpletype_ = p1;
  expr_ = p2;
...
EVarSimpleCast::EVarSimpleCast(const EVarSimpleCast & other)
{
  simpletype_ = other.simpletype_->clone();
  expr_ = other.expr_->clone();
...
EVarSimpleCast &EVarSimpleCast::operator=(const EVarSimpleCast & other)
{
  EVarSimpleCast tmp(other);
  swap(tmp);
  return *this;
}

void EVarSimpleCast::swap(EVarSimpleCast & other)
{
  std::swap(simpletype_, other.simpletype_);
  std::swap(expr_, other.expr_);
...
void EVarSimpleCast::accept(Visitor *v)
{
  v->visitEVarSimpleCast(this);
}

EVarSimpleCast *EVarSimpleCast::clone() const
{
  return new EVarSimpleCast(*this);
}
...
/********************   EArrSimpleCast    ********************/
EArrSimpleCast::EArrSimpleCast(SimpleType *p1, Expr *p2)
{
  simpletype_ = p1;
  expr_ = p2;
...
EArrSimpleCast::EArrSimpleCast(const EArrSimpleCast & other)
{
  simpletype_ = other.simpletype_->clone();
  expr_ = other.expr_->clone();
...
EArrSimpleCast &EArrSimpleCast::operator=(const EArrSimpleCast & other)
{
  EArrSimpleCast tmp(other);
  swap(tmp);
  return *this;
}

void EArrSimpleCast::swap(EArrSimpleCast & other)
{
  std::swap(simpletype_, other.simpletype_);
  std::swap(expr_, other.expr_);
...
void EArrSimpleCast::accept(Visitor *v)
{
  v->visitEArrSimpleCast(this);
}

EArrSimpleCast *EArrSimpleCast::clone() const
{
  return new EArrSimpleCast(*this);
}
...
std::vector<std::string> ListArg::getTypes()  {
...
std::vector<std::string> ListArg::getIdents()  {
    std::vector<std::string> out;
